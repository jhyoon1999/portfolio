...
with tab2 :
    ...
    with st.expander("기존 제작 대비 30% 저렴한 공동생산 방식의 의류제작 플랫폼 개발(2022.06 ~ 2022.12)") :
        ...
        st.markdown("""- 담당 업무
    - 기업 정보 데이터 수집 : 나이스디앤비 기업데이터 구매, 웹스크래핑
    - 데이터 분석 : R 활용
    - 데이터 시각화 플랫폼 개발 : R의 Shiny 패키지 활용
    - ML을 통한 인사이트 발굴 : randomforest, xgboost 활용
                    """)
    ...
    with st.expander("AI 기반 맞춤형 아파트 분석 추천시스템 개발(2022.06 ~ 2022.12)") :
        ...
        st.markdown("""- 담당 업무
    - 데이터 수집 : 공공데이터포털 Open API를 통한 부동산 데이터 수집, 카카오지도를 통한 지오코딩(Geocoding)
    - 데이터 분석 : R 활용
    - 데이터 시각화 : Power BI 활용
    ...
    with st.expander("예측모델링 알고리즘을 활용한 종합 적응적 인지검사 시스템 ACT 개발(2021.10 ~ 2021.12)") :
        ...
        st.markdown("""- 담당 업무
    - 데이터 전처리 및 분석 : R 활용
    - ML을 이용한 적응적 검사 개발 : 논문의 ML 구현 및 학습 진행
    - 결과 보고서 작성
